        ...
        <table class="table">
            <thead class="thead-light" align="center">
                <tr>
                    ...
                    <th>Gender</th>
                    <th>Title</th>
                    <th><a href="/cms/add-user"><button type="button" class="btn btn-primary">Add User</button></a></th>
                </tr>
            </thead>
            <tbody align="center">
    ...
    <div class="modal fade" id="resultModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="/cms/home"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button></a>
				</div>
			</div>
		</div>
	</div>
